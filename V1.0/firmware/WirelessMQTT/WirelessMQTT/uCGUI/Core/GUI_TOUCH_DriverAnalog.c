...
void  GUI_TOUCH_GetxyMinMax(void) {
	#if ((GUI_TOUCH_SWAP_XY==0) && (GUI_TOUCH_MIRROR_X==0)) || ((GUI_TOUCH_SWAP_XY) && (GUI_TOUCH_MIRROR_Y==0))
	xyMinMax[0].Min =	iTouchScreenParam.AD_LEFT;
	#else
	xyMinMax[0].Min =	iTouchScreenParam.AD_RIGHT;
	#endif
	
	#if ((GUI_TOUCH_SWAP_XY==0) && (GUI_TOUCH_MIRROR_X==0)) || ((GUI_TOUCH_SWAP_XY) && (GUI_TOUCH_MIRROR_Y==0))
	xyMinMax[0].Max =	iTouchScreenParam.AD_RIGHT; 
	#else
	xyMinMax[0].Max =	iTouchScreenParam.AD_LEFT; 
	#endif
	
	
  #if ((GUI_TOUCH_SWAP_XY==0) && (GUI_TOUCH_MIRROR_Y==0)) || ((GUI_TOUCH_SWAP_XY) && (GUI_TOUCH_MIRROR_X==0))
  xyMinMax[1].Min = iTouchScreenParam.AD_TOP;
  #else
  xyMinMax[1].Min = iTouchScreenParam.AD_BOTTOM;
  #endif
	
  #if ((GUI_TOUCH_SWAP_XY==0) && (GUI_TOUCH_MIRROR_Y==0)) || ((GUI_TOUCH_SWAP_XY) && (GUI_TOUCH_MIRROR_X==0))
  xyMinMax[1].Max = iTouchScreenParam.AD_BOTTOM; 
  #else
  xyMinMax[1].Max = iTouchScreenParam.AD_TOP; 
  #endif
}
/*********************************************************************
*
