...
static void _DemoButton(void) {
  ...
  GUI_DispStringHCenterAt("Click on phone button...", 60,80);
  GUI_Delay(500);
  /* Create the button */
  hButton = BUTTON_Create(42, 100, 36, 40, GUI_ID_OK, WM_CF_SHOW);
...
void MainTask(void) {
  ...
  GUI_DispStringHCenterAt("WIDGET_PhoneButton - Sample", 60, 5);
  while (1) {
    _DemoButton();
  }
}
