...
void NRF24L01_Init(void)
{
	...
	//GPIOG7,8推挽输出
    GPIO_Initure.Pin=NRF_CE_Pin;	//PG7，8
    GPIO_Initure.Mode=GPIO_MODE_OUTPUT_PP;
    GPIO_Initure.Pull=GPIO_PULLUP;          //上拉
    GPIO_Initure.Speed=GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(NRF_CE_GPIO_Port,&GPIO_Initure);     //初始化
    
    GPIO_Initure.Pin=NRF_CSN_Pin;	//PG7，8
    GPIO_Initure.Mode=GPIO_MODE_OUTPUT_PP;
    GPIO_Initure.Pull=GPIO_PULLUP;          //上拉
    GPIO_Initure.Speed=GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(NRF_CSN_GPIO_Port,&GPIO_Initure);     //初始化
	
	//GPIOG6上拉输入
	GPIO_Initure.Pin=NRF_IRQ_Pin;			//PG6
	GPIO_Initure.Mode=GPIO_MODE_INPUT;      //输入
	HAL_GPIO_Init(NRF_IRQ_GPIO_Port,&GPIO_Initure);     //初始化
...
void NRF24L01_RX_Mode(void)
{
	NRF24L01_CE=0;	  
  	...
  	NRF24L01_Write_Reg(NRF_WRITE_REG+RF_CH,0x40);	        //设置RF通信频率		  
